...
A widget where customers can send feedback to the app admin about bugs, ideas, etc. It is possible to attach a screenshot of the current screen. The feedback is saved in the database and an email is sent to the administrator for notification. 
